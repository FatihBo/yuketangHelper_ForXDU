...
csrftoken = "4H4N7xqBaQ1IGFboK9wZ5BWgI9aBOImv" #需改成自己的
sessionid = "wg1ibfi1nty3iw3wzp4kabv9de7yk764" #需改成自己的
user_id = "47636771"
...
headers = {
    ...
    'Cookie': 'csrftoken=' + csrftoken + '; sessionid=' + sessionid + '; university_id=2924; platform_id=3',
...
def one_video_watcher(video_id,video_name,cid,user_id,classroomid,skuid):
    ...
    url = "https://xidian.yuketang.cn/video-log/heartbeat/"
    get_url = "https://xidian.yuketang.cn/video-log/get_video_watch_progress/?cid="+str(cid)+"&user_id="+user_id+"&classroom_id="+classroomid+"&video_type=video&vtype=rate&video_id=" + str(video_id) + "&snapshot=1&term=latest&uv_id=2924"
...
def get_videos_ids(course_name,classroom_id,course_sign):
    get_homework_ids = "https://xidian.yuketang.cn/mooc-api/v1/lms/learn/course/chapter?cid="+str(classroom_id)+"&term=latest&uv_id=2924&sign="+course_sign
...
if __name__ == "__main__":
    ...
    user_id_url = "https://xidian.yuketang.cn/edu_admin/check_user_session/"
    ...
    # 然后要获取教室id
    get_classroom_id = "https://xidian.yuketang.cn/mooc-api/v1/lms/user/user-courses/?status=1&page=1&no_page=1&term=latest&uv_id=2924"
    submit_url = "https://xidian.yuketang.cn/mooc-api/v1/lms/exercise/problem_apply/?term=latest&uv_id=2924"
